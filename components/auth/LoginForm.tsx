            ...
            <FormField
              ...
              render={ ( { field } ) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input className='bg-slate-100 dark:bg-slate-500 border-0 focus-visible:ring-1 text-black focus-visible:ring-offset-0 dark:text-white' type='password' placeholder="Enter password" autoComplete='current-password' {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              ) }
